      ...
      <div className="return-policy">
        ...
        <section>
          ...
          <p>
            ...
            store, we also automatically receive your computer Internet protocol
        ...
        <section>
          ...
          <p>
            ...
            for your personal information for a secondary reason, such as
            marketing, we will either ask you directly for your expressed
            consent, or provide you with an opportunity to say no.
          </p>
          <p>How do I withdraw my consent?</p>
          <p>
            After you opt-in, if you change your mind, you may withdraw your
            ...
            info@skybluewholesale.com or mailing us at:
          </p>
          <address>
            Sky Blue Wholesale
            <br />
        ...
        <section>
          ...
          <p>
            Our online store is hosted by 3dcart. They provide us with the
            online e-commerce platform that allows us to sell our products and
            services to you.
          </p>
          <p>
            You can read more about how 3dcart uses your Personal Information
            here:{" "}
            <a
              href="https://www.3dcart.com/privacy.html"
              target="_blank"
          ...
          <p>
            Payment: If you choose a direct payment gateway to complete your
            purchase, the online store transmits your credit card data. The
            store data is encrypted through the Payment Card Industry Data
        ...
        <section>
          ...
          <p>
            Once you leave our store website or are redirected to a third-party
        ...
        <section>
          ...
          <p>
            ...
            with AES-256 encryption. Although no method of transmission over the
        ...
        <section>
          ...
          <p>
            Our website uses “Cookies” as data files that are placed on your
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:info@skybluewholesale.com">
              info@skybluewholesale.com
            </a>{" "}
            or by mail at:
          </p>
          <address>
