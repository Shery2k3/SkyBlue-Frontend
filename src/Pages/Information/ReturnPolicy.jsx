    ...
    <Layout pageTitle="Return Policy" isLoading={isLoading}>
      ...
      <div className="return-policy">
        ...
        <section>
          ...
          <p>
            If you haven't received a refund yet, please check your bank or
            credit card account again, then contact the respective financial
            institution, as there is often some processing time before a refund
            is posted.
          </p>
          <p>
            If you've done all of this and you still have not received your
            refund yet, please contact us at{" "}
            <a href="mailto:info@skyglass.ca">info@skyglass.ca</a>.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:info@skyglass.ca">info@skyglass.ca</a> and send your
            item to: 1300 Kamato Rd Mississauga ON L4W 2N2.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            To return your product, you should mail your product to: 1300 Kamato
            Rd Mississauga ON L4W 2N2.
          </p>
          <p>
          ...
          <p>
            Depending on where you live, the time frame to receive your
            exchanged product may vary.
          </p>
          <p>
            If you are returning an item over $75, you should consider using a
            shipping service that offers tracking or purchasing shipping
            insurance. We offer no guarantees towards the receiving of your
            returned item.
          </p>
        </section>
      </div>
